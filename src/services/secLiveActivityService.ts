...
const ISSUER_LOOKUP: Array<{ name: string; keywords: string[] }> = [
  { name: "Vanguard", keywords: ["vanguard"] },
  { name: "BlackRock / iShares", keywords: ["blackrock", "ishares"] },
  { name: "State Street (SPDR)", keywords: ["state street", "spdr", "ssga"] },
  { name: "Invesco Galaxy", keywords: ["invesco", "galaxy"] },
  { name: "Charles Schwab", keywords: ["charles schwab", "schwab"] },
  { name: "JPMorgan", keywords: ["jpmorgan", "j.p. morgan", "jp morgan"] },
  { name: "Dimensional (DFA)", keywords: ["dimensional", "dfa"] },
  { name: "First Trust", keywords: ["first trust"] },
  { name: "Capital Group", keywords: ["capital group", "american funds"] },
  { name: "American Century", keywords: ["american century"] },
  { name: "VanEck", keywords: ["vaneck", "van eck"] },
  { name: "Fidelity Investments", keywords: ["fidelity", "wise origin"] },
  { name: "World Gold Council", keywords: ["world gold council", "world gold trust"] },
  { name: "ProShares", keywords: ["proshares", "pro shares"] },
  { name: "WisdomTree", keywords: ["wisdomtree", "wisdom tree"] },
  { name: "Mirae Asset (Global X)", keywords: ["global x", "mirae asset"] },
  { name: "Direxion (Rafferty)", keywords: ["direxion", "rafferty"] },
  { name: "Goldman Sachs", keywords: ["goldman sachs", "goldman"] },
  { name: "Allianz Investment Mgmt", keywords: ["allianz", "allianzim"] },
  { name: "Franklin Templeton", keywords: ["franklin templeton", "franklin"] },
  { name: "Janus Henderson", keywords: ["janus henderson", "janus"] },
  { name: "Pacer Advisors", keywords: ["pacer", "pacer advisors"] },
  { name: "Innovator", keywords: ["innovator"] },
  { name: "Prudential", keywords: ["prudential", "pgim"] },
  { name: "Northern Trust", keywords: ["northern trust", "flexshares"] },
  { name: "T. Rowe Price", keywords: ["t. rowe price", "t rowe price"] },
  { name: "Victory Capital", keywords: ["victory capital"] },
  { name: "DWS (Xtrackers)", keywords: ["dws", "xtrackers", "dbx"] },
  { name: "SS&C Technologies", keywords: ["ss&c", "alps"] },
  { name: "abrdn", keywords: ["abrdn", "aberdeen"] },
  { name: "Amplify Investments", keywords: ["amplify"] },
  { name: "TIAA", keywords: ["tiaa", "nuveen"] },
  { name: "ARK 21Shares", keywords: ["ark invest", "ark 21shares", "ark investment"] },
  { name: "Grayscale Investments", keywords: ["grayscale"] },
  { name: "Simplify", keywords: ["simplify"] },
  { name: "GraniteShares", keywords: ["graniteshares", "granite shares"] },
  ...
  { name: "REX Shares / Osprey", keywords: ["rex shares", "osprey", "tuttle"] },
];
